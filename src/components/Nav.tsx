...
export function Nav() {
  return (
    <header className="fixed top-0 inset-x-0 z-30 flex items-center justify-between px-6 md:px-16 py-4 bg-strata-ink/80 backdrop-blur-sm border-b border-lichen-dim/30">
      <a href="#main" className="flex items-center gap-2.5 font-display font-semibold text-bone">
        <Image
          src="/logo.png"
          alt="Procambrian"
          width={36}
